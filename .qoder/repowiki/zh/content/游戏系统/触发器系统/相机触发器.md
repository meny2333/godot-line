...
**更新** CamTransitionTrigger脚本已被完全删除，其投影切换功能已由增强的CameraFollower系统替代，新增了lerp_to方法提供更平滑的相机过渡效果。
...
**图表来源**
- [CamShaker.gd:27-33](file://#Template/[Scripts]/CameraScripts/CamShaker.gd#L27-L33)
...
CF --> ST["State.gd"]
GM --> CF
CS["CamShaker.gd"] --> SCN["MainLine.tscn"]
